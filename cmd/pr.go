...
var prCmd = &Command{
	Name:  "pr",
	Short: "Perform detailed analysis of all PRs from specified date",
	Long: `Analyze PRs from GitHub work for the specified date (YYYY-MM-DD) with comprehensive technical and business analysis,
review comments, and learning opportunities. This command provides detailed insights
into each PR worked on the specified date. Uses today's date if no date is provided.`,
	Run: func(cmd *Command, args []string) error {
		...
		fmt.Printf("🔍 Analyzing PRs from %s...\n\n", date)

		analyzer := NewPRAnalyzer(".")
		return analyzer.AnalyzeTodaysPRs(date)
	},
}
